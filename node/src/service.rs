...
pub type Service<B, RA, HF> = sc_service::PartialComponents<
    FullClient<B, RA, HF>,
    FullBackend<B>,
    FullSelectChain<B>,
    BasicQueue<B>,
...
) -> Result<Service<B, RA, HF>, ServiceError>
where
    B: BlockT<Hash = H256>,
    ...
    NB: sc_network::NetworkBackend<B, <B as BlockT>::Hash>,
{
    ...
    if enable_grandpa {
        ...
        let grandpa_voter = sc_consensus_grandpa::run_grandpa_voter(grandpa_config)?;
