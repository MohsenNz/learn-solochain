...
use sp_runtime::{
    ...
    ApplyExtrinsicResult, ConsensusEngineId, ExtrinsicInclusionMode, MultiSignature,
};
#[cfg(feature = "std")]
...
// TODO: find a solution to use MultiSignature if needed
//       currently it makes error
// /// AccountId of it would be AccountId32
...
// TODO: find a solution to use MultiAddress if needed
//       currently it makes error on `Executive::initialize_block`
...
/// Existential deposit.
pub const EXISTENTIAL_DEPOSIT: u128 = 0; //500;
...
parameter_types! {
    ...
    pub const   BlockHashCount  : BlockNumber       = 256;// 2400;
...
impl pallet_balances::Config for Runtime {
    ...
    type MaxFreezes             = ConstU32<1>; //VariantCountOf<RuntimeFreezeReason>;
}
// Transaction-payment
#[rustfmt::skip]
...
parameter_types! {
    ...
    pub WeightPerGas            : Weight                        =
        Weight::from_parts(
            weight_per_gas(BLOCK_GAS_LIMIT, NORMAL_DISPATCH_RATIO, WEIGHT_MILLISECS_PER_BLOCK),
            0
        );
}
...
impl_runtime_apis! {
    ...
    impl fp_rpc::EthereumRuntimeRPCApi<Block> for Runtime {
        ...
        fn call(
            ...
            let weight = <Runtime as pallet_evm::Config>::GasWeightMapping::gas_to_weight(
                gas_limit,
                true // without_base_extrinsic_weight
            );

            let (weight_limit, proof_size_base_cost) = match weight {
